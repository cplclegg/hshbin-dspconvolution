...
In der Welt der digitalen Signalverarbeitung ist die Convolution (deutsch: \glqq Faltung\grqq) ein mathematischer Vorgang, bei dem 
ein Eingangssignal mit einem weiteren Signal, einer sog. Impulsantwort verrechnet wird.
...
Die Convolution beschreibt also mathematisch den Einfluss eines solchen Systems auf ein Eingangssignal.\cite[Kapitel 5]{lyons2011}
...
Allerdings wird im Rahmen dieser Seminararbeit nicht auf die mathematische Definition der
schnellen Fourier Transformation eingegangen, weil dies den Rahmen der Seminararbeit sprengen würde.
