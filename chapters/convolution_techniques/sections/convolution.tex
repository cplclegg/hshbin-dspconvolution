...
charakterisieren lassen. Hier werden die Impulsantwort sowie der Begriff der Convolution-Summe definiert.
...
\end{equation}
Die Gleichung \ref{eq:convolution_sum} wird als \textit{Convolution-Summe} bezeichnet \cite[Seite 22f]{oppenheim1999}. Als kürzere Schreibweise für 
...
kommutativen Eigenschaft der Convolution ist \ref{eq:fir_convsum} äquivalent zu \ref{eq:convolution_sum} \cite[Kapitel 2, Seite 29]{oppenheim1999}. Solche Filter werden \textit{Finite Impulse Response Filter},
...
\begin{figure}[H]
    ...
    \caption{Das geglättete Signal, über das ungeglättete Signal aus Abbildung \ref{fig:comp_sinusoid} vorgeblendet}
