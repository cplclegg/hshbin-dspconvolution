...
kommutativen Eigenschaft der Convolution ist \ref{eq:fir_convsum} äquivalent zu \ref{eq:convolution_sum} \cite[Kapitel 2, Seite 29]{oppenheim1999}. So konstruierte Filter werden \textit{Finite Impulse Response Filter},
