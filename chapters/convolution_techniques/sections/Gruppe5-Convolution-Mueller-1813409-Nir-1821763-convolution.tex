...
Visualisierungen in diesem Abschnitt sind an die Grafiken von Richard Lyons \cite[Kapitel 5]{lyons2011} angelehnt.
Tiefpassfilter können in der diskreten Zeitdomäne durch ein von \cite[Kapitel 5, Seite 220]{lyons2011} \textit{Moving Average Filter} genanntes System realisiert werden.
...
\end{equation}
\cite[Kapitel 5, Seite 172]{lyons2011}.
