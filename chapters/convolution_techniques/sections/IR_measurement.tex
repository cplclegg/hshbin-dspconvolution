\section{Techniken zur Messung von Raum-Impulsantworten} \label{ir_msrmt}
...
an Verfahren mit Einsatz von exponentiellen/logarithmischen Sinus-Sweeps (kurz \textit{ESS/LSS}) geforscht.
...
erkennbar \cite{farina2000}. Angelo Farina beschreibt ein Entfaltungs-Verfahren, mit dem diese Artefakte einfach von der IR getrennt werden können.
