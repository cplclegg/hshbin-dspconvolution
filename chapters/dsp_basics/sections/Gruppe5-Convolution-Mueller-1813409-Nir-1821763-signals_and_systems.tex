...
Stetige Signale werden mit der unabhängigen Variablen in runden Klammern notiert:
...
wobei $n$ den Index des betrachteten Funktionswerts bezeichnet \cite[S. 9]{oppenheim1999}.
...
Jedes diskrete Signal lässt sich als eine Summe skalierter und verzögerter Einheitsimpulsen darstellen \cite[S. 11]{oppenheim1999}.
\paragraph{Systeme}
Ein System produziert als Antwort auf ein Eingangssignal ein Ausgangssignal \cite[Kap. 5]{smith1997}.
Formal definiert \cite[S. 16]{oppenheim1999} ein diskretes System als eine Transformation oder einen Operator, welche(r) ein Eingangssignal $x[n]$
