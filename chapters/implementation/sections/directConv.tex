...
Diese Vorgehensweise ist unter Kenntnis der diskreten Faltungslgeichung \ref{eq:directConv}
...
\begin{equation}
\mathcal{O}(N \cdot M) \approx \mathcal{O}(n^2)
...
von Faltungssummen lange Zeit ausschließlich in der Forschung ihren Platz fanden \cite[Kap. 4]{lyons2010}.
