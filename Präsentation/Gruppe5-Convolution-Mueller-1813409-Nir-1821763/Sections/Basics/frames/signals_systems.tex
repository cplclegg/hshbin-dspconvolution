\begin{frame}[allowframebreaks]{Signale}
    ...
    \begin{itemize}
        \item Signale beschreiben, wie ein Parameter sich in Abhängigkeit eines anderen ändert
...
\begin{frame}[allowframebreaks]{Lineare Zeit-Invariante Systeme}
    ...
    \begin{itemize}
        ...
        \item Verzögertes Eingangssignal $\mapsto$ verzögertes, sonst gleiches, Ausgangssignal.
    \end{itemize}
