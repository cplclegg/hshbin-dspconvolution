\begin{frame}[allowframebreaks]{Convolution-Summe}
    ...
    Summenformel für diskretes Signal:
    ...
    \begin{itemize}
        ...
        \item System könnte unterschiedlich auf Einheitsimpulse an verschiedenen Zeitpunkten reagieren
    \end{itemize}
...
\begin{frame}[allowframebreaks]{Moving Average Filter}
    ...
    Moving Average Filter (Low-Pass FIR-Filter)
    \linebreak
    \begin{itemize}
...
Koeffizienten $\frac{1}{m}$ können als Folge der Länge $m$ mit dem Wert $\frac{1}{m}$ an jedem Index interpretiert werden.
...
\begin{frame}[allowframebreaks]{Convolution-Theorem}
    ...
    \begin{itemize}
        \item Die Convolution-Summe zweier Signale in Zeitdomäne ist äquivalent zum Produkt der Signale in Frequenzdomäne.
    \end{itemize}
